...
data.ml = select(data, c(-"Opération",-"Division",-"Client",-"NombreUnité",-"TypeDocument",
                         ...
                         -"TotalAvances",-"Dossier",-"NuméroClient",-"Vers1",-"Vers2",-"Vers3",-"TotalVersement",-"DésignationTypeDeDocument"))
...
#pu.rf <- randomForest(PrixUnitaire ~ ., data = data.ml, mtry = 3,
#                        importance = TRUE, na.action = na.omit)

#print(pu.rf)
#plot(pu.rf)
#conf <- pu.rf$confusion



#lm = lm(PrixUnitaire ~ ., data= data.ml)
#Pred <- predict(lm, data.ml)
#summary(lm)
```
...
```{r}
ggbetweenstats(data,
Superficie, PrixTotal, outlier.tagging = TRUE)
```
